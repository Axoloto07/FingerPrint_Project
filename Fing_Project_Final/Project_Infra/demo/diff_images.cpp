...
//-----------------------1D translation--------------------------------------------
    ...
    diff_res.save("demo_results/diff_res.png");
    diff.save("demo_results/diff.png");
...
//-----------------------2D translation--------------------------------------------
    ...
    diff_2d_res.save("demo_results/diff_2d_res.png");
    diff_2d.save("demo_results/diff_2d.png");
...
//-----------------------2D translation + rotation--------------------------------------------
    ...
    diff_3d_res.save("demo_results/diff_3d_res.png");
    diff_3d.save("demo_results/diff_3d.png");
    return 0;
}